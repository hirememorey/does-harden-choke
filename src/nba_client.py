"""NBA Stats API client — adapted from resilience-basketball."""
...
class NBAStatsClient:
    ...
    def __init__(
        ...
        # Light urllib3 retries; outer loop in _make_request handles flaky 500s.
        ...
        # Headers matched to working browser requests (verified via Playwright).
    ...
    def get_league_game_finder(
        ...
        """All team (or player) games for a season — used for series map."""
        return self._make_request(
            "leaguegamefinder",
            {
    ...
    def get_play_by_play(
        ...
        """Play-by-play for a single game via playbyplayv3.

        Note: playbyplayv2 currently returns an empty payload from stats.nba.com.
        """
...
if __name__ == "__main__":
    ...
    season = "2023-24"
    harden_id = config.GROUP_A["James Harden"]["nba_id"]
    resp = client.get_player_game_logs(harden_id, season, "Regular Season", "Base")
